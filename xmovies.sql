...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th12 03, 2019 lúc 06:04 PM
...
CREATE TABLE `category` (
  ...
  `descibe` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Cấu trúc bảng cho bảng `functionGlobal`
--
...
--
-- Đang đổ dữ liệu cho bảng `functionGlobal`
--
...
--
-- Cấu trúc bảng cho bảng `functionRoom`
--
...
--
-- Đang đổ dữ liệu cho bảng `functionRoom`
--
...
--
-- Cấu trúc bảng cho bảng `historyAction`
--
...
--
-- Đang đổ dữ liệu cho bảng `historyAction`
--
...
--
-- Cấu trúc bảng cho bảng `questionSurvey`
--
...
--
-- Đang đổ dữ liệu cho bảng `questionSurvey`
--
...
--
-- Cấu trúc bảng cho bảng `roleGlobal`
--
...
--
-- Đang đổ dữ liệu cho bảng `roleGlobal`
--
...
--
-- Cấu trúc bảng cho bảng `roleRoom`
--
...
--
-- Đang đổ dữ liệu cho bảng `roleRoom`
--
...
--
-- Đang đổ dữ liệu cho bảng `room_user`
--
...
--
-- Cấu trúc bảng cho bảng `statusRoom`
--
...
--
-- Đang đổ dữ liệu cho bảng `statusRoom`
--
...
(4, 'hfvuisdhi', 'sdfvhisdhifh', '2019-11-19 12:36:25', 1, 1);
...
(4, 1, 4, '2019-11-19 12:36:25', 0),
(5, 2, 4, '2019-11-19 12:36:25', 0);
...
INSERT INTO `user` (`id`, `userName`, `fullName`, `email`, `dateOfBirth`, `active_flg`, `password`, `role_id`, `update_date`, `remember_token`, `avatar`) VALUES
(1, 'admin', 'TRAN KIM HIEU', 'hieu@gmail', '2019-02-08', 1, '$2y$10$zSLvWNPQ8IrrRcOzVfPIJu5AmTTx9QWa4GVcbo8iplxhgINQ96mJG', 1, '2019-02-09 00:00:00', NULL, 'avatar'),
(2, 'hieutk', 'ThanLibra', 'hieu@gmail', '2019-02-09', 1, '$2y$10$zSLvWNPQ8IrrRcOzVfPIJu5AmTTx9QWa4GVcbo8iplxhgINQ96mJG', 2, '2019-02-09 00:00:00', NULL, 'avatar'),
(3, 'ntl', 'Nguyễn Tuấn Linh', 'thunderking9x@gmail.com', '1999-03-12', 1, '$2y$10$ddbq2e11eQ.HAKrdrcnhieZtZ7.1ngz4Twajd3xcKsMvsCEvlzaVm', 2, '2019-11-19 12:40:25', NULL, NULL);
...
--
-- Chỉ mục cho bảng `functionGlobal`
--
...
--
-- Chỉ mục cho bảng `historyAction`
--
...
--
-- Chỉ mục cho bảng `questionSurvey`
--
...
--
-- Chỉ mục cho bảng `roleGlobal`
--
ALTER TABLE `roleGlobal`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `roleRoom`
--
...
--
-- AUTO_INCREMENT cho bảng `functionGlobal`
--
ALTER TABLE `functionGlobal`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `functionRoom`
--
ALTER TABLE `functionRoom`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `historyAction`
--
ALTER TABLE `historyAction`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT cho bảng `questionSurvey`
--
ALTER TABLE `questionSurvey`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `roleGlobal`
--
ALTER TABLE `roleGlobal`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `roleRoom`
--
ALTER TABLE `roleRoom`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `room_user`
--
ALTER TABLE `room_user`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `statusRoom`
--
ALTER TABLE `statusRoom`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
-- Các ràng buộc cho bảng `functionGlobal`
--
ALTER TABLE `functionGlobal`
...
--
-- Các ràng buộc cho bảng `functionRoom`
--
ALTER TABLE `functionRoom`
...
--
-- Các ràng buộc cho bảng `historyAction`
--
ALTER TABLE `historyAction`
...
--
-- Các ràng buộc cho bảng `questionSurvey`
--
ALTER TABLE `questionSurvey`
...
--
-- Các ràng buộc cho bảng `room_user`
--
ALTER TABLE `room_user`
...
('root', '[{\"db\":\"xmovies\",\"table\":\"slides\"},{\"db\":\"xmovies\",\"table\":\"movie\"},{\"db\":\"xmovies\",\"table\":\"category\"},{\"db\":\"xmovies\",\"table\":\"user\"},{\"db\":\"Xmovies\",\"table\":\"user\"},{\"db\":\"Xmovies\",\"table\":\"category\"},{\"db\":\"Xmovies\",\"table\":\"movie\"},{\"db\":\"Xmovies\",\"table\":\"comment\"},{\"db\":\"Xmovies\",\"table\":\"episodes\"},{\"db\":\"Xmovies\",\"table\":\"follow\"}]');
...
('xmovies', 'comment', 'content'),
('xmovies', 'movie', 'country'),
('xmovies', 'slides', 'banner');
...
('root', 'xmovies', 'movie', '{\"sorted_col\":\"`id_movie`  DESC\"}');
...
('root', '{\"lang\":\"vi\",\"Console\\/Mode\":\"collapse\"}');
...
--
CREATE DATABASE IF NOT EXISTS `xmovies` DEFAULT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci;
USE `xmovies`;
